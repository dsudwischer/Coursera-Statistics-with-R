...
<ol>
<li> 
  <b>Posterior - $P(M_1 \text{ is Good} ~|~ \text{Win on } M_1)$ <br/> 
  Prior - $P(M_1 \text{ is Good})$ <br/>
  Likelihood - $P(\text{Win on } M_1 ~|~ M_1 \text{ is Good})$ </b>
</li>
<li> 
...
6. Why do the posterior probabilities for Machine 1 and Machine 2 mirror each other?
<ol>
