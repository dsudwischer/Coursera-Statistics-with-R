...
<li> <b>The probability that the true proportion of females lies in this interval is 0.95.</b></li>
...
alpha <- a + x
beta <- b + n
print(qgamma(c(0.05, 0.95), shape = alpha, rate = beta))
```