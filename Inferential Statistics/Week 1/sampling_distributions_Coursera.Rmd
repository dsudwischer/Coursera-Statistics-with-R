...
print(paste("Number of Observsations:", dim(sample_means50)[1]))
```
...
print("Each observation represents the mean of a sample of size 10 drawn from the population (with replacement).")
```
...
print(paste("An unbiased estimate of the mean home price for the population is the mean of the sampling distribution, i.e.", mean(sample_means50$x_bar)))
```
...
ggplot(data = sample_means150, aes(x = x_bar)) +
  geom_histogram(binwidth = 2000)
print(paste("An unbiased estimate of the mean home price for the population is the mean of the sampling distribution, i.e.", mean(sample_means150$x_bar)))
```
...
# type your code for this Exercise here, and Run Document
print(paste("Point estimate for population mean of home prices:", mean(sample_n(ames, 15)$price)))
```
...
ggplot(data = sample_means15, aes(x = x_bar)) +
  geom_histogram(binwidth = 2000)
print(paste("An unbiased estimate of the mean home price for the population is the mean of the sampling distribution, i.e.", mean(sample_means15$x_bar)))
```
...
print(paste("Standard deviation of sample mean for sample_means50:", sd(sample_means50$x_bar)))
print(paste("Standard deviation of sample mean for sample_means150:", sd(sample_means150$x_bar)))
```
