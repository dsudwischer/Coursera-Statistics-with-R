...
**Research quesion 3:**
Finally, we will have a quick glance on a potential correlation between depression and hours of work. We will distinguish between veterans and non-veterans as they may differ in that.
```{r}
